variable "memory_limits_low_perc_state_enabled" {
  type        = bool
  default     = false
...
variable "memory_limits_low_perc_state_severity" {
  type    = string
  default = "minor"
}

variable "memory_limits_low_perc_state_note" {
  type    = string
  default = ""
}

variable "memory_limits_low_perc_state_docs" {
  type    = string
...
variable "memory_limits_low_perc_state_filter_override" {
  type    = string
  default = ""
}

variable "memory_limits_low_perc_state_alerting_enabled" {
  type    = bool
  default = true
}

variable "memory_limits_low_perc_state_no_data_timeframe" {
  type    = number
  default = null
}

variable "memory_limits_low_perc_state_notify_no_data" {
  type    = bool
  default = false
}

variable "memory_limits_low_perc_state_ok_threshold" {
  type    = number
  default = null
}
